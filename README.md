...
print("Value from dictionary:", dict_value)  # Output: Alice
...
Dictionaries: Dictionaries do not keep the key-value pairs in any particular sequence.
...
Explanation:
•	List Operations:
o	numbers.append(60): Adds the number 60 to the end of the list.
o	numbers.remove(30): Removes the first occurrence of the number 30 from the list.
o	numbers[2]: Accesses the element at index 2 (third element).
o	len(numbers): Returns the number of elements in the list
